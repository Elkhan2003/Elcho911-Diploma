...
function OffCanvasExample({ name, ...props }) {
    ...
    const questions = [
        ...
        {
            questionText: 'Тело цикла для вычисления значений функций f(x)=x4, на отрезке [-5,5] с шагом 0.1 будет иметь вид:',
            answerOptions: [
        ...
        <>
            ...
            <Offcanvas className={css.Offcanvas__block} show={show} onHide={handleClose} {...props}>
                <Offcanvas.Header closeButton>
                    <Offcanvas.Title className={css.Offcanvas__title}>Циклы-2</Offcanvas.Title>
                </Offcanvas.Header>
                <Offcanvas.Body>
