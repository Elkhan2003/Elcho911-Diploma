	...
	const questions = [
		...
		},
		{
			...
			answerOptions: [
				...
				{
					answerText: "Выбор наилучшего метода из имеющихся",
					isCorrect: false
				},
				{
					answerText:
		...
		},
		{
			...
			answerOptions: [
				...
				{
					answerText: "Постановка задачи, разработка математической модели",
					isCorrect: true
				},
				{
					answerText:
		...
		},
		{
			...
			answerOptions: [
				{
					answerText: "Преобразует десятичное число х в строку из k символов",
					isCorrect: false
				},
				{
					answerText: "Преобразует десятичное число х в строку из k символов",
				...
				{
					answerText: "Уменьшает значение переменной х на величину k",
					isCorrect: false
				},
				{
					answerText:
	...
	return (
		<>
			{options.map((props, index) => (
				<OffCanvasExample key={index} {...props} />
			))}
		</>
	);
}
