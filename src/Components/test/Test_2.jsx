			...
			<Container>
				<div className={css.footer__buttons}>
					<div className={css.footer__button}>
						<p>Операторы ветвления и выбора</p>
						<p>
							<Example />
						</p>
					</div>
...
function OffCanvasExample({ name, ...props }) {
	...
	const questions = [
		...
		},
		{
			...
			answerOptions: [
				{
					answerText: "Операции типа сложения: +, –, or, xor",
					isCorrect: false
				},
				{
					answerText: "Операции отношения: =, <>, <, >, <= ,> =, in",
					isCorrect: false
				},
				{
					answerText: "Унарная операция not, унарный минус –, взятие адреса @",
					isCorrect: true
				},
				{
					answerText: "Операции типа умножения: *, /, div, mod, and, shl, shr.",
					isCorrect: false
				}
			]
		},
		{
			...
			answerOptions: [
				{
					answerText: "If B=0 then writeln (‘Деление на нуль невозможно’)",
					isCorrect: false
				},
