                    ...
                    <Row>
                        <Col sm={3}>
                            <Nav variant="pills" className="flex-column">
                                <Nav.Item className={css.about__tabs}>
                                    <Nav.Link eventKey="first">О системе PascalABC.NET</Nav.Link>
                                </Nav.Item>
                                <Nav.Item className={css.about__tabs}>
                                    <Nav.Link eventKey="second">Коротко о главном</Nav.Link>
                                </Nav.Item >
                                <Nav.Item className={css.about__tabs}>
                                    <Nav.Link eventKey="three">Что такое .NET</Nav.Link>
                                </Nav.Item >
                                <Nav.Item className={css.about__tabs}>
                                    <Nav.Link eventKey="four">Преимущества PascalABC.NET</Nav.Link>
                                </Nav.Item >
                                <Nav.Item className={css.about__tabs}>
                                    <Nav.Link eventKey="five">Отличия языка PascalABC.NET от Delphi Object Pascal</Nav.Link>
                                </Nav.Item>
                            </Nav>
                        </Col>
                        <Col sm={9}>
                                ...
                                <Tab.Pane eventKey="three">
                                    <Tabs defaultActiveKey="1" id="uncontrolled-tab-example" className="mb-3">
                                        <Tab eventKey="1" title="1">
                                            ...
                                            <div>
                                                <p>
                                                    Платформа Microsoft .NET - это комплекс программ, устанавливаемый поверх операционной системы и обеспечивающий выполнение программ, написанных специально для .NET. .NET-программы компактны, пользуются единым набором типов данных и библиотек. Компания Microsoft активно развивает платформу .NET, выпуская новые версии с расширенными возможностями. На момент начала 2019 г. последней версией является .NET 4.7.1.
                                                </p>
                                                <p>
                                                ...
                                                <p>
                                                    Имеется открытая кроссплатформенная реализация среды Microsoft.NET - <a href="https://www.mono-project.com/" target="_ blank">среда Mono</a>, позволяющая в частности разрабатывать и запускать .NET-программы под Linux.
                                                </p>
                                                <p>
                                        ...
                                        <Tab eventKey="3" title="3">
                                            ...
                                            <p>Отметим, что достоинства платформы .NET многократно перекрывают ее недостатки.</p>
                                        </Tab>
                                    </Tabs>
                                </Tab.Pane>
                                    ...
                                    <Tabs defaultActiveKey="1" id="uncontrolled-tab-example" className="mb-3">
                                        ...
                                        <Tab eventKey="3" title="3">
                                            ...
                                            <div>
                                                ...
                                                <p>
                                                    Модуль растровой графики GraphWPF и модуль векторных графических объектов WPFObjects и модуль трёхмерной графики Graph3D могут быть использованы для создания простейших графических. а также интерактивных анимационных приложений, управляемых событиями.
                                                </p>
                                                <p>
